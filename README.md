...
Uygulamanın en önemli etkinliği nefes egzersizidir. Bu bölümde 4-7-8 nefes kuralı uygulanır. Ekranda yer alan balon 4 saniye boyunca şişer, 7 saniye sabit kalır ve 8 saniyede küçülerek kaybolur. Bu döngü, kullanıcının nefesine odaklanmasını ve sakinleşmesini sağlar.

Odaklanma etkinliğinde ekrana dağılan yapraklar, kullanıcı tarafından bir sepette toplanır. Bu basit görev zihinsel toparlanmayı ve dikkat kontrolünü destekler. Zihni dağıtmaya yönelik etkinlikte ise ekrana doğru süzülen balonlar tek tek patlatılır. Amaç, kullanıcının düşüncelerinden uzaklaşmasını sağlamaktır.

Motivasyon etkinliğinde arka planda sakin bir müzik çalar ve ekranda “Ben daha iyisine layığım”, “Her şey daha güzel olacak”, “Mutlu olacağım” gibi olumlu cümleler yer alır. Kullanıcı bu cümlelere dokundukça farklı motive edici mesajlarla karşılaşır.
